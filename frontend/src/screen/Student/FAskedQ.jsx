    ...
    <div>
        ...
        <ul style={{ marginTop: '-80px'}}>
                {questions.map((question, index) => (
                  <div style={{ marginBottom: '40px',listStyleType: 'none', boxSizing: 'border-box', position: 'relative', width: '800px', height: '200px', left: '359px', top: '391px', background: '#FFFFFF', border: '1px solid #000000' }}>
                    <li key={index}>
